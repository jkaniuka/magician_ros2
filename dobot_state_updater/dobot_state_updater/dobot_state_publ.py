...
class DobotPublisher(Node):
    ...
    def ignore_msg(self):
        manipulators[self.get_namespace()].serial.reset_input_buffer()
    ...
    def timer_callback_alarms(self):
        with suppress(ValueError, TypeError):
            alarms_array = manipulators[self.get_namespace()].get_alarms_state()
    ...
    def timer_callback(self):
        ...
        with suppress(ValueError, TypeError):
            ...
            if self.RAIL_IN_USE == True:
                ...
                dobot_rail_pose.data = float(manipulators[self.get_namespace()].get_sliding_rail_pose())
